...
[Generator]
public class ViewModelRegisterGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterPostInitializationOutput((ctx) => ctx.AddSource(
            Constants.AutoRegisterViewModelsAttribute,
    ...
    private void Execute(SourceProductionContext context, (Compilation Left, ImmutableArray<ClassDeclarationSyntax> Right) compilationTuple)
    {
        ...
        var attributeAutoGenSymbol = compilation.GetTypeByMetadataName(Constants.AutoRegisterViewModelsFullName);
        ...
        context.AddSource(Constants.ViewModelGenFileName, source);
    }
        ...
        var source = $$"""
                       ...
                       namespace {{Constants.Namespace}}
                       {
                           public static class RegisterViewModels
                           {
                               ...
                               public static Microsoft.Extensions.DependencyInjection.IServiceCollection AddTransientViewModels(this Microsoft.Extensions.DependencyInjection.IServiceCollection services)
                               {
                                    {{code}}
    ...
    private static string BuildAutoRoutesAttribute()
    {
        ...
        return $$"""
                 ...
                 public class {{Constants.AutoRegisterViewModelsAttribute}}: Attribute
                 {
                     ...
                     public {{Constants.AutoRegisterViewModelsAttribute}}(string suffix)
                     {
                         Suffix = suffix;
                     }
